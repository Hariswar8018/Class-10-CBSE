    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        Navigator.push(
            ...
            child: Add_Blog (id: 'Result10',), type: PageTransitionType.rightToLeft, duration: Duration(milliseconds: 800)
        ));
      },
      ) ,
      drawer : Df.buildDrawer(context, n),
      body : StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Result10").snapshots(),
    ...
    return Padding(
      ...
      child: InkWell(
        onLongPress: () async {
            ...
            await FirebaseFirestore.instance.collection("Result10").doc(c.date).delete();

        },
        onTap: () async {

          await FirebaseFirestore.instance.collection("Result10").doc(c.date).update({
